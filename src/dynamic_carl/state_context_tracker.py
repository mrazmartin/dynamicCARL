...
class GymStateContextLogger(gym.Wrapper):
    ...
    def reset(
        ...
        *,
        ...
        self._compressor.end_episode()  # flush partial episode if reset mid-episode
    ...
    def close(self):
        self._compressor.end_episode()  # flush the in-progress episode if training ended mid-episode
        return super().close()
